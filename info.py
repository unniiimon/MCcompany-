...
PICS = (environ.get('PICS', 'https://i.ibb.co/TMzySBkp/image.jpg' 'https://i.ibb.co/8gw4y8sZ/image.jpg')).split()
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002405645789')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+agpA4_bznFAwZGVl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviecenter225') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviecenter225_owner')
